...
- `../orchestration/promise-gates.md` — where walkthroughs sit in the gate.
- `../review/intent-audit.md` — the auditor consumes walkthrough narratives as primary evidence.

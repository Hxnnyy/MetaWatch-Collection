...
2. **Promise-gate audit** — at every promise gate, T2 and above (see `../orchestration/promise-gates.md`).
3. **Tripwire audits** — off-schedule, whenever the orchestrator hits a tripwire (below).
4. **Concurrence calls** — tier changes and above-default breakglass (`../orchestration/process-calibration.md`). Single review; the answer stands.
...
- `../orchestration/intent-contract.md` — the reference document.
- `../orchestration/process-calibration.md` — tiers, rigour classes, breakglass.
- `../orchestration/promise-gates.md` — where gate audits fit.
- `../verification/walkthrough-verification.md` — the gate evidence the auditor leans on.

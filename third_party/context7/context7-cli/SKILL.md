---
name: context7-cli
description: Use for ctx7/context7 commands, current library docs, skill management, or Context7 MCP setup.
---
...
Prefer running the CLI without installing it globally:

```bash
npx ctx7@latest <command>
```

Only install the CLI in a project-local or user-managed location if the user explicitly asks. Do not install Node packages globally without the user's approval.
